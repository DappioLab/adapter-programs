...
use crate::common::traits::vault::TokenizedShares;
use crate::farms::{Farm, quarry::Quarry};
...
impl From<Quarry> for QuarryVariant {
    fn from(val: Quarry) -> Self {
        match val {
            Quarry::VANILLA => Self::Vanilla,
            Quarry::SABER => Self::Saber,
            Quarry::SUNNY => Self::Sunny,
            Quarry::UNKNOWN => Self::UNKNOWN,
        }
    }
}
